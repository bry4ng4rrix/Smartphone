...
@transaction.atomic
def create_supplier_order(*, description, prix_fournisseur, fret_import, douane, meta_ads, lines, created_by):
...
def recompute_costs(supplier_order):
    ...
    coût total / quantité totale ; réparti sur chaque ligne (§7.6 README)."""
...
def receive_supplier_order(supplier_order, user):
    ...
    passe la commande à 'RECU' (§7.6 README — 'Chaque entrée crée des
    mouvements stock entrée fournisseur')."""
