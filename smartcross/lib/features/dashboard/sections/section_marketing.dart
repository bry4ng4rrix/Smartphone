...
/// `ReportRequest.pour(ReportSection.marketing, filter, extra: …)` +
/// `ref.watch(reportsProvider(request))`, données typées [MarketingData].
class SectionMarketing extends ConsumerWidget {
...
ReportPrintable? marketingPrintable(MarketingData data) => null;
