...
/**
 * Centre de rapports du gérant : 8 rapports dans une seule page, un seul
 * affiché à la fois (onglets / menu « Liste des rapports » sur mobile),
 * filtres de période communs, données agrégées côté serveur
 * (orders/reporting.py) et mises en cache par section.
 */
  ...
  if (!isGerant) {
    return (
      <div className="p-6">
        ...
        <p className="text-sm text-muted-foreground mt-2">Accès refusé — les rapports sont réservés au gérant.</p>
      </div>
    );
  }
