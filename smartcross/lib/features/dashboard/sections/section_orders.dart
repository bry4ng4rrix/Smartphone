...
/// « Commandes » — port de components/reports/section-orders.tsx.
///
/// STUB : en cours de portage par un autre agent. Contrat :
/// `ReportRequest.pour(ReportSection.orders, filter, extra: …)` +
/// `ref.watch(reportsProvider(request))`, données typées [OrdersData].
...
ReportPrintable? ordersPrintable(OrdersData data) => null;
